...
{
    public abstract class CalibrationVerifyInfoVO
    {
        /// <summary>
        /// 标定名称
        /// </summary>
    ...
    /// Checkerboard 验证
    /// </summary>
    public class CheckerboardVerifyInfoVO : CalibrationVerifyInfoVO
    {
        /// <summary>
        /// 测量标准品验证启用
        /// </summary>
    ...
    /// Handeye 验证
    /// </summary>
    public class HandeyeVerifyInfoVO : CalibrationVerifyInfoVO
    {
        /// <summary>
        /// 倾斜验证启用
        /// </summary>
