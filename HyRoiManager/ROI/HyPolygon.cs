...
namespace HyRoiManager.ROI
{
    ...
    public class HyPolygon : BaseHyROI
    {
        ...
        public override void Draw(PointF ImgStartPoint, PointF ImgEndPoint)
        {
            ...
            if (ImgStartPoint == ImgEndPoint && ImgStartPoint == SpecialPoint)
            {
                if (Count > 2)
                {
               ...
               ImgEndPoint.X == 1 && ImgEndPoint.Y == 0)
            {
                ...
                {
                    PolygonPoints.RemoveAt(Count - 1);
                    PolygonPoints.RemoveAt(Count - 2);
                }
                IsDrawing = false;
            }
        }
        ...
        //    if (ImgStartPoint != SpecialPoint && ImgEndPoint != SpecialPoint)
        //    {
        //        if (Count == 0)
        //        {
        //            PolygonPoints.Add(ImgStartPoint);
        //            PolygonPoints.Add(ImgEndPoint);
        //        }
        //        else
        //        {
        //            PolygonPoints[Count - 1] = ImgEndPoint;
